...
common/ThirdParty/SEGGER/SEGGER/%.o: ../common/ThirdParty/SEGGER/SEGGER/%.S common/ThirdParty/SEGGER/SEGGER/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I"D:/Mastering RTOS Hands on FreeRTOS/RTOS_Workspacee/common/ThirdParty/SEGGER/Config" -I"D:/Mastering RTOS Hands on FreeRTOS/RTOS_Workspacee/common/ThirdParty/SEGGER" -I"D:/tkhtn_final/003_multi_task/common/ThirdParty/SEGGER/SEGGER" -I"D:/tkhtn_final/003_multi_task/common/ThirdParty/SEGGER/Config" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
